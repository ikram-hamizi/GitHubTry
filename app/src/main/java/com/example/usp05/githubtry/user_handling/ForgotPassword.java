...
public class ForgotPassword extends Activity {
    ...
    public void onChangePasswordClick(View view) {
        if(view.getId() == R.id.changePassword) {
            ...
            String secQuestion1 = ((EditText) findViewById(R.id.fp_secQ1)).getText().toString();
            String secQuestion2 = ((EditText) findViewById(R.id.fp_secQ2)).getText().toString();
            String secQuestion3 = ((EditText) findViewById(R.id.fp_secQ3)).getText().toString();
            ...
            if(username.isEmpty()|| secQuestion1.isEmpty()|| secQuestion2.isEmpty() || secQuestion3.isEmpty()) {
                ...
                boolean found = UDS.checkUser(username);
                if(!found) {
                    Toast message = Toast.makeText(this, R.string.invalidUsername, Toast.LENGTH_SHORT);
                    message.show();
                }
                else {
                    // gets sec answers from the database to compare
                    Cursor cursor = UDS.getSecAnswers(username);
                    ...
                    if(!(secAnswer1.equals(secQuestion1) && secAnswer2.equals(secQuestion2)
                        ...
                        Toast message = Toast.makeText(this, R.string.invalidSecQuestions, Toast.LENGTH_SHORT);
                        message.show();
                    }
                    else {
